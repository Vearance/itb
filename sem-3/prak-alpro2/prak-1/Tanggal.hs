...
hariDalamBulan :: Int -> Int -> Int
hariDalamBulan b t
    | b == 2 && True == (isKabisat t) = 29
    | b == 2 && False == (isKabisat t) = 28
...
isValid :: Tanggal -> Bool
isValid t
    | (hari t >= 1) && (hari t <= hariDalamBulan (bulan t) (tahun t)) && (bulan t >= 1) && (bulan t <= 12) && (tahun t >= 1) = True
    | otherwise = False
