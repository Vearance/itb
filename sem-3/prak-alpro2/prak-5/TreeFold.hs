...
treeFoldPost f b (Node x l r) =
    let leftAcc  = treeFoldPost f b l
        rightAcc = treeFoldPost f b r
    in f leftAcc rightAcc x
...
treeFoldPre f b (Node x l r) =
    let leftAcc  = treeFoldPre f b l
        rightAcc = treeFoldPre f b r
    in f x leftAcc rightAcc
...
treeFoldIn f b (Node x l r) =
    let leftAcc  = treeFoldIn f b l
        rightAcc = treeFoldIn f b r
    in f leftAcc x rightAcc