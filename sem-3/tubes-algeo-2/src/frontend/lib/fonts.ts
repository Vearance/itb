...
export const sfmono = localFont({
    src: [
        { path: '../fonts/sf-mono/SFMonoBold.otf', weight: '700', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoBoldItalic.otf', weight: '700', style: 'italic' },
        { path: '../fonts/sf-mono/SFMonoHeavy.otf', weight: '800', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoHeavyItalic.otf', weight: '800', style: 'italic' },
        { path: '../fonts/sf-mono/SFMonoLight.otf', weight: '300', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoLightItalic.otf', weight: '300', style: 'italic' },
        { path: '../fonts/sf-mono/SFMonoMedium.otf', weight: '500', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoMediumItalic.otf', weight: '500', style: 'italic' },
        { path: '../fonts/sf-mono/SFMonoRegular.otf', weight: '400', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoRegularItalic.otf', weight: '400', style: 'italic' },
        { path: '../fonts/sf-mono/SFMonoSemibold.otf', weight: '600', style: 'normal' },
        { path: '../fonts/sf-mono/SFMonoSemiboldItalic.otf', weight: '600', style: 'italic' },
    ],
    display: 'swap',
