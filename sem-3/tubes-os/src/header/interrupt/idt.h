...
#define INTERRUPT_GATE_PRIVILEGE_KERNEL 0
#define INTERRUPT_GATE_PRIVILEGE_USER   3
 ...
 * @param gate_32     Is this gate size 32-bit? 0 = 16-bit, 1 = 32-bit
 * @param _r_bit_3    Reserved for idtgate type, bit length: 1
 * @param privilege   Descriptor privilege level, ring 0-3
 * @param presence    Is this gate present? 0 = Not present, 1 = Present
