...
// Maximum page directory table count to map entire system memory
#define PAGING_DIRECTORY_TABLE_MAX_COUNT 32
// Kernel virtual address base (higher half kernel)
 ...
 * @param user_supervisor   Indicate whether this page can be accessed by user-mode
 * @param page_write_through Indicate whether page write-through is enabled
 * @param page_cache_disable Indicate whether page cache is disabled
 * @param accessed_bit      Indicate whether this page has been accessed
 * @param dirty_bit         Indicate whether this page has been written to
 * @param use_pagesize_4_mb Indicate whether this entry use 4 MB page size
 */
 ...
 * @param free_page_frame_count Number of free page frame available
 * @param last_allocated_frame_index Index of the last allocated page frame
 */
