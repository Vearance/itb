...
/**
 * Activate timer interrupt for scheduler
 */
...
/**
 * Handle timer interrupt: save current context and switch to next process
 * Called from main_interrupt_handler when timer IRQ is received
 * 
 * @param frame The interrupt frame containing CPU state at interrupt time
 */
